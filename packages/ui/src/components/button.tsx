  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-body font-medium ring-offset-bg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-border-strong bg-bg hover:bg-bg-sunken hover:text-fg',
        secondary:
          'bg-bg-sunken text-fg hover:bg-border',
        ghost: 'hover:bg-bg-sunken hover:text-fg',
      ...
      size: {
        ...
        icon: 'h-10 w-10',
        touch: 'h-14 w-full rounded-lg text-h3', // campo: touch target 56px
      },
    },
    defaultVariants: {
      variant: 'default',
